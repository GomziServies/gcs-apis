...
module.exports.getRemainingDocs = getRemainingDocs;

const getRemainingPages = (totalDocs, skip, limit) => {
    return countPages(totalDocs, limit) - (skip / limit);
}
module.exports.getRemainingPages = getRemainingPages;
...
const getPaginationInfo = (totalDocs, { skip, limit, page, ...otherOptions }) => {
    ...
    try {
        if (pg.maxLimit) Object.assign(info, {
